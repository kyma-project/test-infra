...
// It provides a set of functions to trigge a pipeline, get its status, and check the logs.
// It also includes fnctions to run tests on the build logs and timeline.
