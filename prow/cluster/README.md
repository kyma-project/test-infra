...
```
  ...
  ├── 09-gce-ssd-retain_storageclass.yaml #  The definition of the GCE SSD StorageClass required to storage GitHub token cache by ghProxy.
  ├── 10-ghproxy.yaml #  The definition of the ghProxy, a reverse proxy HTTP cache, required to reduce API token usage by prow.
