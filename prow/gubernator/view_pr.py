            ...
            if user:
                ...
                cats = [
                    ...
                    ('Incoming', lambda p: user != p.payload['author'] and
                     ...
                     'is:open is:pr user:kyma-project assignee:%s' % user),
                    ('Outgoing', lambda p: user == p.payload['author'],
                     'is:open is:pr user:kyma-project author:%s' % user),
                ]
            else:
                cats = [('Open Kyma Project PRs', lambda x: True,
                    'is:open is:pr user:kyma-project')]
