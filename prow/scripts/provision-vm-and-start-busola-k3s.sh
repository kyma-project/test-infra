...
--quiet --zone="${ZONE}" --command="sudo bash ${SCRIPT_DIR}/cluster-integration/busola-integration-test-k3s.sh ${SCOPE}" --ssh-flag="-o ServerAliveInterval=30" \
"busola-integration-test-${RANDOM_ID}"
