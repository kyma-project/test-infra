...
utils::ssh_to_vm_with_script -z "${ZONE}" -n "kyma-dashboard-smoke-test-${RANDOM_ID}" -c "sudo bash" -p "${SCRIPT_DIR}/cluster-integration/kyma-dashboard-smoke-test-prod.sh"
