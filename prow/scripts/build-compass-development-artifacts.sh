...
gsutil cp  "${ARTIFACTS}/kyma-installation.yaml" "${COMPASS_DEVELOPMENT_ARTIFACTS_BUCKET}/${BUCKET_DIR}/kyma-installation.yaml"
...
if [[ "${BUILD_TYPE}" == "master" ]]; then
  ...
  gsutil cp  "${ARTIFACTS}/kyma-installation.yaml" "${COMPASS_DEVELOPMENT_ARTIFACTS_BUCKET}/master/kyma-installation.yaml"
fi
