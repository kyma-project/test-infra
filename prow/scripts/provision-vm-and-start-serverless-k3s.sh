...
utils::ssh_to_vm_with_script -z "${ZONE}" -n "kyma-integration-test-${RANDOM_ID}" -c "sudo bash ~/test-infra/prow/scripts/cluster-integration/serverless-integration-k3s.sh"
