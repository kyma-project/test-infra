...
gcloud compute ssh --quiet --zone="${ZONE}" --command="sudo bash" --ssh-flag="-ServerAliveInterval=15" "kyma-integration-test-${RANDOM_ID}" < "${SCRIPT_DIR}/cluster-integration/kyma-integration-minikube.sh"
