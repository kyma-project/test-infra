...
BASE64_CLOUD_CREDENTIALS_FILE_CONTENT=$(< "${BACKUP_CREDENTIALS}")
BASE64_CLOUD_CREDENTIALS_FILE_CONTENT_BASE64=$(echo -n "${BASE64_CLOUD_CREDENTIALS_FILE_CONTENT}" | base64 | tr -d '\n')
