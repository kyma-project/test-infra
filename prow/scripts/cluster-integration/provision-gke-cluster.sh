...
gcloud container clusters create "${CLUSTER_NAME}" "${CLUSTER_VERSION_PARAM}" "${MACHINE_TYPE_PARAM}" "${NUM_NODES_PARAM}" --labels="job=kyma-gke-integration,cluster=${CLUSTER_NAME}"
