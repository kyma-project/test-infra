...
function installKyma() {
  ...
  if [[ "$BUILD_TYPE" != "release" ]]; then
    ...
    GOOGLE_APPLICATION_CREDENTIALS="${SA_TEST_GCR_PUSH_GOOGLE_APPLICATION_CREDENTIALS}" KYMA_INSTALLER_IMAGE="${KYMA_INSTALLER_IMAGE}" "${TEST_INFRA_CLUSTER_INTEGRATION_SCRIPTS}"/create-image.sh
  fi
