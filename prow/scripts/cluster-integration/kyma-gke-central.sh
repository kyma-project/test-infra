...
if [[ "$BUILD_TYPE" == "release" ]]; then
    ...
    gsutil cp "${KYMA_ARTIFACTS_BUCKET}/${RELEASE_VERSION}/kyma-installer-crd.yaml" /tmp/kyma-gke-central/downloaded-installer-crd.yaml
    kubectl apply -f /tmp/kyma-gke-central/downloaded-installer-crd.yaml
