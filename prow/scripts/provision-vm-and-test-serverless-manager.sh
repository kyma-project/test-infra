...
utils::ssh_to_vm_with_script -z "${ZONE}" -n "serverless-manager-test-${RANDOM_ID}" -c 'sudo bash -c sleep 2000 && "source /etc/profile && cd $HOME/serverless-manager && make test"'
