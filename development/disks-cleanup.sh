...
echo "Removing GCP disk resources allocated by failed/terminated integration jobs..."
...
go run "${DEVELOPMENT_DIR}"/tools/cmd/diskscollector/main.go  --project="${PROJECT}" --dryRun=false
status=$?
