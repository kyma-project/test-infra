...
| **--kymaInstallerCR**          |    No    | The string value with the name of the file with list of components installed by the installer. It defaults to `kyma-installer-cr.yaml`.
