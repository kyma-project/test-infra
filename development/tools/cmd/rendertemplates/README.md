...
- **Global Config Sets** defined in the **globalSets** key in the `config.yaml` file:
...
- **Local Config Sets** defined under the **localSets** parameter for each **to** key in the `config.yaml` file or in data files in the `templates/data` directory:
...
- **One-job Config Sets** defined in the **jobConfig** key:
