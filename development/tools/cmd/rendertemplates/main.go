...
func hasProwjboType(r []Repo, prowjobtype string) bool {
	for _, repo := range r {
...
func hasPresubmit(r []Repo) bool {
	return hasProwjboType(r, "type_presubmit")
}

func hasPostsubmit(r []Repo) bool {
	return hasProwjboType(r, "type_postsubmit")
}

func hasPeriodic(r []Repo) bool {
	return hasProwjboType(r, "type_periodic")
}
