...
func (_m *ObjectIterator) Next() (client.ObjectAttrs, error) {
	ret := _m.Called()

	var r0 client.ObjectAttrs
	if rf, ok := ret.Get(0).(func() client.ObjectAttrs); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(client.ObjectAttrs)
		}
	}
