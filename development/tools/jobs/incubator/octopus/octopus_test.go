...
func TestOctopusJobsPresubmit(t *testing.T) {
	...
	actualPresubmit := tester.FindPresubmitJobByNameAndBranch(jobConfig.PresubmitsStatic["kyma-incubator/octopus"], "pre-master-kyma-incubator-octopus", "master")
...
func TestOctopusJobPostsubmit(t *testing.T) {
	...
	actualPostsubmit := tester.FindPostsubmitJobByNameAndBranch(jobConfig.PostsubmitsStatic["kyma-incubator/octopus"], "post-master-kyma-incubator-octopus", "master")
