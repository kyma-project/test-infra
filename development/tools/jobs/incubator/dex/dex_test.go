...
func TestDexJobsPresubmit(t *testing.T) {
	...
	actualPresubmit := tester.FindPresubmitJobByNameAndBranch(jobConfig.AllStaticPresubmits([]string{"kyma-incubator/dex"}), "pre-main-kyma-incubator-dex", "kyma-master")
...
func TestDexJobPostsubmit(t *testing.T) {
	...
	actualPostsubmit := tester.FindPostsubmitJobByNameAndBranch(jobConfig.AllStaticPostsubmits([]string{"kyma-incubator/dex"}), "post-main-kyma-incubator-dex", "kyma-master")
