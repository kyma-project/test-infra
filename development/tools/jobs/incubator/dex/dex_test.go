...
func TestDexJobsPresubmit(t *testing.T) {
	...
	actualPresubmit := tester.FindPresubmitJobByNameAndBranch(jobConfig.PresubmitsStatic["kyma-incubator/dex"], "pre-master-kyma-incubator-dex", "kyma-master")
...
func TestDexJobPostsubmit(t *testing.T) {
	...
	actualPostsubmit := tester.FindPostsubmitJobByNameAndBranch(jobConfig.PostsubmitsStatic["kyma-incubator/dex"], "post-master-kyma-incubator-dex", "kyma-master")
