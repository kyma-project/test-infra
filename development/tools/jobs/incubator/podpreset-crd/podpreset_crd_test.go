...
func TestPodpresetCrdJobsPresubmit(t *testing.T) {
	...
	kymaPresubmits, ex := jobConfig.Presubmits["kyma-incubator/podpreset-crd"]
	assert.True(t, ex)
	...
	assert.Equal(t, "github.com/kyma-incubator/podpreset-crd", actualPresubmit.PathAlias)
...
func TestPodpresetCrdJobPostsubmit(t *testing.T) {
	...
	kymaPost, ex := jobConfig.Postsubmits["kyma-incubator/podpreset-crd"]
	assert.True(t, ex)
	...
	assert.Equal(t, "github.com/kyma-incubator/podpreset-crd", actualPost.PathAlias)
