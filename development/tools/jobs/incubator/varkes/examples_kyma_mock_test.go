...
func TestExamplesKymaMockJobsPresubmit(t *testing.T) {
	// WHEN
	jobConfig, err := tester.ReadJobConfig("./../../../../../prow/jobs/incubator/varkes/examples/kyma-mock/examples-kyma-mock.yaml")
	// THEN
	...
	expName := "pre-master-varkes-examples-kyma-mock"
	...
	assert.Equal(t, "^examples/kyma-mock/", actualPresubmit.RunIfChanged)
	assert.Equal(t, tester.ImageNodeBuildpackLatest, actualPresubmit.Spec.Containers[0].Image)
	assert.Equal(t, []string{"/home/prow/go/src/github.com/kyma-project/test-infra/prow/scripts/build.sh"}, actualPresubmit.Spec.Containers[0].Command)
	assert.Equal(t, []string{"/home/prow/go/src/github.com/kyma-incubator/varkes/examples/kyma-mock"}, actualPresubmit.Spec.Containers[0].Args)
}

func TestExamplesKymaMockJobPostsubmit(t *testing.T) {
	// WHEN
	jobConfig, err := tester.ReadJobConfig("./../../../../../prow/jobs/incubator/varkes/examples/kyma-mock/examples-kyma-mock.yaml")
	// THEN
	require.NoError(t, err)
	...
	expName := "post-master-varkes-examples-kyma-mock"
	...
	assert.Equal(t, "^examples/kyma-mock/", actualPost.RunIfChanged)
	assert.Equal(t, tester.ImageNodeBuildpackLatest, actualPost.Spec.Containers[0].Image)
	assert.Equal(t, []string{"/home/prow/go/src/github.com/kyma-project/test-infra/prow/scripts/build.sh"}, actualPost.Spec.Containers[0].Command)
	assert.Equal(t, []string{"/home/prow/go/src/github.com/kyma-incubator/varkes/examples/kyma-mock"}, actualPost.Spec.Containers[0].Args)
}
