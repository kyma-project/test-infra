...
func TestOdataMockJobsPresubmit(t *testing.T) {
	// WHEN
	jobConfig, err := tester.ReadJobConfig("./../../../../../prow/jobs/incubator/varkes/examples/odata-mock/examples-odata-mock.yaml")
	// THEN
	...
	expName := "pre-master-varkes-examples-odata-mock"
	...
	assert.Equal(t, "^examples/odata-mock/", actualPresubmit.RunIfChanged)
	assert.Equal(t, tester.ImageNodeBuildpackLatest, actualPresubmit.Spec.Containers[0].Image)
	assert.Equal(t, []string{"/home/prow/go/src/github.com/kyma-project/test-infra/prow/scripts/build.sh"}, actualPresubmit.Spec.Containers[0].Command)
	assert.Equal(t, []string{"/home/prow/go/src/github.com/kyma-incubator/varkes/examples/odata-mock"}, actualPresubmit.Spec.Containers[0].Args)
}
...
func TestOdataMockJobPostsubmit(t *testing.T) {
	...
	expName := "post-master-varkes-examples-odata-mock"
	...
	assert.Equal(t, "^examples/odata-mock/", actualPost.RunIfChanged)
	assert.Equal(t, tester.ImageNodeBuildpackLatest, actualPost.Spec.Containers[0].Image)
	assert.Equal(t, []string{"/home/prow/go/src/github.com/kyma-project/test-infra/prow/scripts/build.sh"}, actualPost.Spec.Containers[0].Command)
	assert.Equal(t, []string{"/home/prow/go/src/github.com/kyma-incubator/varkes/examples/odata-mock"}, actualPost.Spec.Containers[0].Args)
}
