...
func TestExamplesCombinedOdataMockJobsPresubmit(t *testing.T) {
	...
	expName := "pre-master-varkes-examples-combined-odata-mock"
	...
	assert.Equal(t, "^examples/combined-odata-mock/", actualPresubmit.RunIfChanged)
...
func TestExamplesCombinedOdataMockJobPostsubmit(t *testing.T) {
	...
	expName := "post-master-varkes-examples-combined-odata-mock"
	...
	assert.Equal(t, "^examples/combined-odata-mock/", actualPost.RunIfChanged)
	assert.Equal(t, tester.ImageNodeBuildpackLatest, actualPost.Spec.Containers[0].Image)
	assert.Equal(t, []string{"/home/prow/go/src/github.com/kyma-project/test-infra/prow/scripts/build.sh"}, actualPost.Spec.Containers[0].Command)
	assert.Equal(t, []string{"/home/prow/go/src/github.com/kyma-incubator/varkes/examples/combined-odata-mock"}, actualPost.Spec.Containers[0].Args)
}
