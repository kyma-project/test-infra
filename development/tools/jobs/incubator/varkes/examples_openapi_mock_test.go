...
func TestExamplesOpenapiMockJobsPresubmit(t *testing.T) {
	// WHEN
	...
	expName := "pre-master-varkes-examples-openapi-mock"
	...
	assert.Equal(t, "^examples/openapi-mock/", actualPresubmit.RunIfChanged)
...
func TestExamplesOpenapiMockJobPostsubmit(t *testing.T) {
	// WHEN
	jobConfig, err := tester.ReadJobConfig("./../../../../../prow/jobs/incubator/varkes/examples/openapi-mock/examples-openapi-mock.yaml")
	// THEN
	require.NoError(t, err)
	...
	expName := "post-master-varkes-examples-openapi-mock"
	...
	assert.Equal(t, "^examples/openapi-mock/", actualPost.RunIfChanged)
	assert.Equal(t, tester.ImageNodeBuildpackLatest, actualPost.Spec.Containers[0].Image)
	assert.Equal(t, []string{"/home/prow/go/src/github.com/kyma-project/test-infra/prow/scripts/build.sh"}, actualPost.Spec.Containers[0].Command)
	assert.Equal(t, []string{"/home/prow/go/src/github.com/kyma-incubator/varkes/examples/openapi-mock"}, actualPost.Spec.Containers[0].Args)
}
