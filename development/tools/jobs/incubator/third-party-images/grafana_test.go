...
const grafanaJobPath = "../../../../../prow/jobs/incubator/third-party-images/third-party-images.yaml"
...
func TestGrafanaJobsPresubmit(t *testing.T) {
	...
	actualPresubmit := tester.FindPresubmitJobByNameAndBranch(jobConfig.AllStaticPresubmits([]string{"kyma-incubator/third-party-images"}), "pre-master-tpi-grafana", "master")
	...
	assert.Equal(t, []string{"/home/prow/go/src/github.com/kyma-incubator/third-party-images/grafana", "ci-pr"}, actualPresubmit.Spec.Containers[0].Args)
}
...
func TestGrafanaJobPostsubmit(t *testing.T) {
	...
	actualPostsubmit := tester.FindPostsubmitJobByNameAndBranch(jobConfig.AllStaticPostsubmits([]string{"kyma-incubator/third-party-images"}), "post-master-tpi-grafana", "master")
	...
	assert.Equal(t, []string{"/home/prow/go/src/github.com/kyma-incubator/third-party-images/grafana", "ci-master"}, actualPostsubmit.Spec.Containers[0].Args)
}
