...
const dockerRegistryJobPath = "../../../../../prow/jobs/incubator/third-party-images/third-party-images.yaml"
...
func TestDockerRegistryJobsPresubmit(t *testing.T) {
	...
	actualPresubmit := tester.FindPresubmitJobByNameAndBranch(jobConfig.AllStaticPresubmits([]string{"kyma-incubator/third-party-images"}), "pre-master-tpi-docker-registry", "master")
	...
	assert.Equal(t, "^docker-registry/", actualPresubmit.RunIfChanged)
	...
	assert.Equal(t, []string{"/home/prow/go/src/github.com/kyma-incubator/third-party-images/docker-registry", "ci-pr"}, actualPresubmit.Spec.Containers[0].Args)
}
...
func TestDockerRegistryJobPostsubmit(t *testing.T) {
	...
	actualPostsubmit := tester.FindPostsubmitJobByNameAndBranch(jobConfig.AllStaticPostsubmits([]string{"kyma-incubator/third-party-images"}), "post-master-tpi-docker-registry", "master")
	...
	assert.Equal(t, []string{"/home/prow/go/src/github.com/kyma-incubator/third-party-images/docker-registry", "ci-master"}, actualPostsubmit.Spec.Containers[0].Args)
}
