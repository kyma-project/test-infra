...
func TestDockerRegistryJobsPresubmit(t *testing.T) {
	...
	assert.Equal(t, []string{"/home/prow/go/src/github.com/kyma-incubator/third-party-images/docker-registry"}, actualPresubmit.Spec.Containers[0].Args)
}
...
func TestDockerRegistryJobPostsubmit(t *testing.T) {
	...
	assert.Equal(t, []string{"/home/prow/go/src/github.com/kyma-incubator/third-party-images/docker-registry"}, actualPostsubmit.Spec.Containers[0].Args)
}
