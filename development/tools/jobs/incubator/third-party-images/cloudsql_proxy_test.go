...
const cloudSQLProxyJobPath = "../../../../../prow/jobs/incubator/third-party-images/third-party-images.yaml"
...
func TestCloudSQLProxyJobsPresubmit(t *testing.T) {
	...
	assert.Equal(t, []string{"/home/prow/go/src/github.com/kyma-incubator/third-party-images/cloudsql-proxy", "ci-pr"}, actualPresubmit.Spec.Containers[0].Args)
}
...
func TestCloudSQLProxyJobPostsubmit(t *testing.T) {
	...
	assert.Equal(t, []string{"/home/prow/go/src/github.com/kyma-incubator/third-party-images/cloudsql-proxy", "ci-master"}, actualPostsubmit.Spec.Containers[0].Args)
}
