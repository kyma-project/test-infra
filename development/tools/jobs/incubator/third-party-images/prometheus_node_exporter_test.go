...
const nodeExporterJobPath = "../../../../../prow/jobs/incubator/third-party-images/third-party-images.yaml"
...
func TestNodeExporterJobsPresubmit(t *testing.T) {
	...
	assert.Equal(t, []string{"/home/prow/go/src/github.com/kyma-incubator/third-party-images/prometheus-node-exporter", "ci-pr"}, actualPresubmit.Spec.Containers[0].Args)
}
...
func TestNodeExporterJobPostsubmit(t *testing.T) {
	...
	assert.Equal(t, []string{"/home/prow/go/src/github.com/kyma-incubator/third-party-images/prometheus-node-exporter", "ci-master"}, actualPostsubmit.Spec.Containers[0].Args)
}
