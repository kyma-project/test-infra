...
const fluentbitJobPath = "../../../../../prow/jobs/incubator/third-party-images/third-party-images.yaml"
...
func TestFluentbitJobsPresubmit(t *testing.T) {
	...
	actualPresubmit := tester.FindPresubmitJobByNameAndBranch(jobConfig.AllStaticPresubmits([]string{"kyma-incubator/third-party-images"}), "pre-master-tpi-fluent-bit", "master")
	...
	assert.Equal(t, []string{"/home/prow/go/src/github.com/kyma-incubator/third-party-images/fluent-bit", "ci-pr"}, actualPresubmit.Spec.Containers[0].Args)
}
...
func TestFluentbitJobPostsubmit(t *testing.T) {
	...
	actualPostsubmit := tester.FindPostsubmitJobByNameAndBranch(jobConfig.AllStaticPostsubmits([]string{"kyma-incubator/third-party-images"}), "post-master-tpi-fluent-bit", "master")
	...
	assert.Equal(t, []string{"/home/prow/go/src/github.com/kyma-incubator/third-party-images/fluent-bit", "ci-master"}, actualPostsubmit.Spec.Containers[0].Args)
}
