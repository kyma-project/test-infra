...
const runtimeAgentJobPath = "./../../../../../prow/jobs/incubator/compass/components/runtime-agent/runtime-agent.yaml"
...
func TestRuntimeAgentJobReleases(t *testing.T) {
	...
	for _, currentRelease := range tester.GetKymaReleaseBranchesBesides(unsupportedReleases) {
		t.Run(currentRelease, func(t *testing.T) {
			...
			actualPre := tester.FindPresubmitJobByName(jobConfig.Presubmits["kyma-incubator/compass"], tester.GetReleaseJobName("compass-components-runtime-agent", currentRelease), currentRelease)
			...
			tester.AssertThatExecGolangBuildpack(t, actualPre.JobBase, tester.ImageGolangBuildpack1_11, "/home/prow/go/src/github.com/kyma-incubator/compass/components/runtime-agent")
		})
	}
}
...
func TestRuntimeAgentJobPresubmit(t *testing.T) {
	...
	actualPre := tester.FindPresubmitJobByName(jobConfig.Presubmits["kyma-incubator/compass"], "pre-master-compass-components-runtime-agent", "master")
	require.NotNil(t, actualPre)
	...
	assert.Equal(t, "^components/runtime-agent/", actualPre.RunIfChanged)
	tester.AssertThatJobRunIfChanged(t, *actualPre, "components/runtime-agent/some_random_file.go")
	tester.AssertThatExecGolangBuildpack(t, actualPre.JobBase, tester.ImageGolangBuildpack1_11, "/home/prow/go/src/github.com/kyma-incubator/compass/components/runtime-agent")
}
...
func TestRuntimeAgentJobPostsubmit(t *testing.T) {
	...
	actualPost := tester.FindPostsubmitJobByName(jobConfig.Postsubmits["kyma-incubator/compass"], "post-master-compass-components-runtime-agent", "master")
	...
	assert.Equal(t, "^components/runtime-agent/", actualPost.RunIfChanged)
	tester.AssertThatJobRunIfChanged(t, *actualPost, "components/runtime-agent/some_random_file.go")
	tester.AssertThatExecGolangBuildpack(t, actualPost.JobBase, tester.ImageGolangBuildpack1_11, "/home/prow/go/src/github.com/kyma-incubator/compass/components/runtime-agent")
}
