...
func TestApiGatewayJobPostsubmit(t *testing.T) {
	...
	actualPostsubmit := tester.FindPostsubmitJobByNameAndBranch(jobConfig.Postsubmits["kyma-incubator/api-gateway"], "post-master-kyma-incubator-api-gateway", "master")
