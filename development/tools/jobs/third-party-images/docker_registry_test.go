...
const dockerRegistryJobPath = "../../../../prow/jobs/third-party-images/third-party-images.yaml"
...
func TestDockerRegistryJobsPresubmit(t *testing.T) {
	...
	actualPresubmit := tester.FindPresubmitJobByNameAndBranch(jobConfig.AllStaticPresubmits([]string{"kyma-project/third-party-images"}), "pre-master-tpi-docker-registry", "master")
	...
	assert.Equal(t, []string{"/home/prow/go/src/github.com/kyma-project/third-party-images/docker-registry", "ci-pr"}, actualPresubmit.Spec.Containers[0].Args)
}
...
func TestDockerRegistryJobPostsubmit(t *testing.T) {
	...
	actualPostsubmit := tester.FindPostsubmitJobByNameAndBranch(jobConfig.AllStaticPostsubmits([]string{"kyma-project/third-party-images"}), "post-master-tpi-docker-registry", "master")
	...
	assert.Equal(t, []string{"/home/prow/go/src/github.com/kyma-project/third-party-images/docker-registry", "ci-master"}, actualPostsubmit.Spec.Containers[0].Args)
}
