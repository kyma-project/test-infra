...
const cloudSQLProxyJobPath = "../../../../prow/jobs/third-party-images/third-party-images.yaml"
...
func TestCloudSQLProxyJobsPresubmit(t *testing.T) {
	...
	actualPresubmit := tester.FindPresubmitJobByNameAndBranch(jobConfig.AllStaticPresubmits([]string{"kyma-project/third-party-images"}), "pre-master-tpi-cloudsql-proxy", "master")
	...
	assert.Equal(t, []string{"/home/prow/go/src/github.com/kyma-project/third-party-images/cloudsql-proxy", "ci-pr"}, actualPresubmit.Spec.Containers[0].Args)
}
...
func TestCloudSQLProxyJobPostsubmit(t *testing.T) {
	...
	actualPostsubmit := tester.FindPostsubmitJobByNameAndBranch(jobConfig.AllStaticPostsubmits([]string{"kyma-project/third-party-images"}), "post-master-tpi-cloudsql-proxy", "master")
