...
func TestJaegerOperatorJobsPresubmit(t *testing.T) {
	...
	actualPresubmit := tester.FindPresubmitJobByNameAndBranch(jobConfig.AllStaticPresubmits([]string{"kyma-project/third-party-images"}), "pre-master-tpi-jaeger-operator", "main")
...
func TestJaegerOperatorJobPostsubmit(t *testing.T) {
	...
	actualPostsubmit := tester.FindPostsubmitJobByNameAndBranch(jobConfig.AllStaticPostsubmits([]string{"kyma-project/third-party-images"}), "post-master-tpi-jaeger-operator", "main")
