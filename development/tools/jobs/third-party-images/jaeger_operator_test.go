...
const jaegerOperatorJobPath = "../../../../prow/jobs/third-party-images/third-party-images.yaml"
...
func TestJaegerOperatorJobsPresubmit(t *testing.T) {
	...
	actualPresubmit := tester.FindPresubmitJobByNameAndBranch(jobConfig.AllStaticPresubmits([]string{"kyma-project/third-party-images"}), "pre-master-tpi-jaeger-operator", "master")
	...
	assert.Equal(t, []string{"/home/prow/go/src/github.com/kyma-project/third-party-images/jaeger-operator", "ci-pr"}, actualPresubmit.Spec.Containers[0].Args)
}
...
func TestJaegerOperatorJobPostsubmit(t *testing.T) {
	...
	actualPostsubmit := tester.FindPostsubmitJobByNameAndBranch(jobConfig.AllStaticPostsubmits([]string{"kyma-project/third-party-images"}), "post-master-tpi-jaeger-operator", "master")
	...
	assert.Equal(t, []string{"/home/prow/go/src/github.com/kyma-project/third-party-images/jaeger-operator", "ci-master"}, actualPostsubmit.Spec.Containers[0].Args)
}
