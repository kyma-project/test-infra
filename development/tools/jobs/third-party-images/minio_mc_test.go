...
const minioMCJobPath = "../../../../prow/jobs/third-party-images/third-party-images.yaml"
...
func TestMinioMCJobsPresubmit(t *testing.T) {
	...
	actualPresubmit := tester.FindPresubmitJobByNameAndBranch(jobConfig.AllStaticPresubmits([]string{"kyma-project/third-party-images"}), "pre-main-tpi-minio-mc", "main")
	...
	assert.Equal(t, []string{"/home/prow/go/src/github.com/kyma-project/third-party-images/minio-mc", "ci-pr"}, actualPresubmit.Spec.Containers[0].Args)
}
...
func TestMinioMCJobPostsubmit(t *testing.T) {
	...
	actualPostsubmit := tester.FindPostsubmitJobByNameAndBranch(jobConfig.AllStaticPostsubmits([]string{"kyma-project/third-party-images"}), "post-main-tpi-minio-mc", "main")
	...
	assert.Equal(t, []string{"/home/prow/go/src/github.com/kyma-project/third-party-images/minio-mc", "ci-main"}, actualPostsubmit.Spec.Containers[0].Args)
}
