...
const minioJobPath = "../../../../prow/jobs/third-party-images/third-party-images.yaml"
...
func TestMinioJobsPresubmit(t *testing.T) {
	...
	actualPresubmit := tester.FindPresubmitJobByNameAndBranch(jobConfig.AllStaticPresubmits([]string{"kyma-project/third-party-images"}), "pre-master-tpi-minio", "master")
	...
	assert.Equal(t, []string{"/home/prow/go/src/github.com/kyma-project/third-party-images/minio", "ci-pr"}, actualPresubmit.Spec.Containers[0].Args)
}
...
func TestMinioJobPostsubmit(t *testing.T) {
	...
	actualPostsubmit := tester.FindPostsubmitJobByNameAndBranch(jobConfig.AllStaticPostsubmits([]string{"kyma-project/third-party-images"}), "post-master-tpi-minio", "master")
	...
	assert.Equal(t, []string{"/home/prow/go/src/github.com/kyma-project/third-party-images/minio", "ci-master"}, actualPostsubmit.Spec.Containers[0].Args)
}
