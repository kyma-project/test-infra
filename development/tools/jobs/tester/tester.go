...
const (
	...
	ImageGolangBuildpack1_16 = "eu.gcr.io/kyma-project/test-infra/buildpack-golang:v20211006-af227109"
	// ImageGolangBuildpack1_16LibGit2_1_1 means Golang buildpack image with G 1.16.1 and libgit2-dev 1.1
	...
	ImageGolangKubebuilder2BuildpackLatest = "eu.gcr.io/kyma-project/test-infra/buildpack-golang:v20211006-af227109" // see https://github.com/kyma-project/test-infra/pull/3738
	// ImageNodeBuildpackLatest means Node.js buildpack image (node v12)
	ImageNodeBuildpackLatest = "eu.gcr.io/kyma-project/test-infra/buildpack-node:v20211006-af227109"
	// ImageBootstrapTestInfraLatest means it's used in test-infra prowjob defs.
	ImageBootstrapTestInfraLatest = "eu.gcr.io/kyma-project/test-infra/bootstrap:v20211005-0e8c8173"

	// ImageKymaIntegrationLatest represents kyma integration image with kubectl 1.16
	ImageKymaIntegrationLatest = "eu.gcr.io/kyma-project/test-infra/kyma-integration:v20210927-76bcfd5e"
	// ImageGolangToolboxLatest represents the latest version of the golang buildpack toolbox
	ImageGolangToolboxLatest = "eu.gcr.io/kyma-project/test-infra/buildpack-golang:v20211006-af227109" // see https://github.com/kyma-project/test-infra/pull/3738
	// ImageProwToolsLatest represents the latest version of the prow-tools image
	ImageProwToolsLatest = "eu.gcr.io/kyma-project/test-infra/prow-tools:v20210907-d10c077a"
