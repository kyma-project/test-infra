...
const (
	...
	ImageNodeBuildpackLatest = "eu.gcr.io/kyma-project/test-infra/buildpack-node:v20220113-247913b9"
	...
	ImageProwToolsLatest = "eu.gcr.io/kyma-project/test-infra/prow-tools:v20220216-8fd49df6"
