...
const (
	...
	ImageGolangBuildpack1_16 = "eu.gcr.io/kyma-project/test-infra/buildpack-golang:v20220329-f79922b9"
	// ImageGolangKubebuilder2BuildpackLatest means Golang buildpack with Kubebuilder2 image
	ImageGolangKubebuilder2BuildpackLatest = "eu.gcr.io/kyma-project/test-infra/buildpack-golang:v20220329-f79922b9" // see https://github.com/kyma-project/test-infra/pull/3738
	...
	ImageKymaIntegrationLatest = "eu.gcr.io/kyma-project/test-infra/kyma-integration:v20220321-a507afbe"
	// ImageGolangToolboxLatest represents the latest version of the golang buildpack toolbox
	ImageGolangToolboxLatest = "eu.gcr.io/kyma-project/test-infra/buildpack-golang:v20220329-f79922b9" // see https://github.com/kyma-project/test-infra/pull/3738
	// ImageProwToolsLatest represents the latest version of the prow-tools image
	ImageProwToolsLatest = "eu.gcr.io/kyma-project/test-infra/prow-tools:v20220329-d40b81ee"
