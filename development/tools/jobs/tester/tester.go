...
const (
	...
	ImageGolangBuildpack1_16 = "eu.gcr.io/kyma-project/test-infra/buildpack-golang:v20220311-42c0b238"
	// ImageGolangKubebuilder2BuildpackLatest means Golang buildpack with Kubebuilder2 image
	ImageGolangKubebuilder2BuildpackLatest = "eu.gcr.io/kyma-project/test-infra/buildpack-golang:v20220311-42c0b238" // see https://github.com/kyma-project/test-infra/pull/3738
	...
	ImageGolangToolboxLatest = "eu.gcr.io/kyma-project/test-infra/buildpack-golang:v20220311-42c0b238" // see https://github.com/kyma-project/test-infra/pull/3738
	// ImageProwToolsLatest represents the latest version of the prow-tools image
	ImageProwToolsLatest = "eu.gcr.io/kyma-project/test-infra/prow-tools:v20220310-0f4c05df"
