...
func TestWebsiteGovernanceJobPresubmit(t *testing.T) {
	...
	expName := "pre-main-website-governance"
...
func TestWebsiteGovernanceJobPeriodic(t *testing.T) {
	...
	tester.AssertThatHasExtraRepoRefCustom(t, actualPeriodic.JobBase.UtilityConfig, []string{"test-infra", "website"}, []string{"main", "main"})
