...
func TestBrokersJobPresubmit(t *testing.T) {
	...
	expName := "pre-master-console-brokers"
	...
	assert.Equal(t, "(^brokers/)|(^components/react)", actualPresubmit.RunIfChanged)
...
func TestBrokersJobPostsubmit(t *testing.T) {
	...
	expName := "post-master-console-brokers"
	...
	assert.Equal(t, "(^brokers/)|(^components/react/)", actualPost.RunIfChanged)
