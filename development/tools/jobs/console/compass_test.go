...
func TestCompassJobPresubmit(t *testing.T) {
	...
	// assert.Equal(t, tester.ImageNodeBuildpackLatest, actualPresubmit.Spec.Containers[0].Image) todo
...
func TestCompassJobPostsubmit(t *testing.T) {
	...
	//assert.Equal(t, tester.ImageNodeChromiumBuildpackLatest, actualPost.Spec.Containers[0].Image) todo
