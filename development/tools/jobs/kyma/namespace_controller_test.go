...
func TestNamespaceControllerJobsPresubmit(t *testing.T) {
	...
	expName := "kyma-components-namespace-controller"
...
func TestNamespaceControllerJobPostsubmit(t *testing.T) {
	...
	assert.Equal(t, "^components/namespace-controller/", actualPost.RunIfChanged)
	assert.Equal(t, tester.ImageGolangBuildpackLatest, actualPost.Spec.Containers[0].Image)
	assert.Equal(t, []string{"/home/prow/go/src/github.com/kyma-project/test-infra/prow/scripts/build.sh"}, actualPost.Spec.Containers[0].Command)
	assert.Equal(t, []string{"/home/prow/go/src/github.com/kyma-project/kyma/components/namespace-controller"}, actualPost.Spec.Containers[0].Args)
}
