...
func TestStabilityCheckerJobsPresubmit(t *testing.T) {
	...
	assert.Equal(t, []string{"/home/prow/go/src/github.com/kyma-project/kyma/tools/stability-checker"}, actualPresubmit.Spec.Containers[0].Args)
}
...
func TestStabilityCheckerJobPostsubmit(t *testing.T) {
	...
	assert.Equal(t, []string{"/home/prow/go/src/github.com/kyma-project/kyma/tools/stability-checker"}, actualPost.Spec.Containers[0].Args)
}
