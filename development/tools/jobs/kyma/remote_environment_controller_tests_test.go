...
func TestRemoteEnvironmentControllerTestsJobsPresubmit(t *testing.T) {
	...
	expName := "kyma-tests-remote-environment-controller-tests"
	...
	tester.AssertThatJobRunIfChanged(t, actualPresubmit, "tests/remote-environment-controller-tests/test")
	assert.Equal(t, "^tests/remote-environment-controller-tests/", actualPresubmit.RunIfChanged)
...
func TestRemoteEnvironmentControllerTestsJobPostsubmit(t *testing.T) {
	...
	assert.Equal(t, "^tests/remote-environment-controller-tests/", actualPost.RunIfChanged)
	assert.Equal(t, tester.ImageGolangBuildpackLatest, actualPost.Spec.Containers[0].Image)
	assert.Equal(t, []string{"/home/prow/go/src/github.com/kyma-project/test-infra/prow/scripts/build.sh"}, actualPost.Spec.Containers[0].Command)
	assert.Equal(t, []string{"/home/prow/go/src/github.com/kyma-project/kyma/tests/remote-environment-controller-tests"}, actualPost.Spec.Containers[0].Args)
}
