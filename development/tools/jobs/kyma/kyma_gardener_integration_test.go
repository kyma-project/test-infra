...
func TestKymaGardenerAzureKymaToKyma2JobPeriodics(t *testing.T) {
	...
	assert.Equal(t, []string{"/home/prow/go/src/github.com/kyma-project/test-infra/prow/scripts/cluster-integration/kyma-upgrade-gardener-kyma-to-kyma2.sh"}, job.Spec.Containers[0].Command)
