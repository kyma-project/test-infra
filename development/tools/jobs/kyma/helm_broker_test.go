...
func TestHelmBrokerJobsPresubmit(t *testing.T) {
	...
	assert.Equal(t, []string{"/home/prow/go/src/github.com/kyma-project/kyma/components/helm-broker"}, actualPresubmit.Spec.Containers[0].Args)
}
...
func TestHelmBrokerJobPostsubmit(t *testing.T) {
	...
	assert.Equal(t, []string{"/home/prow/go/src/github.com/kyma-project/kyma/components/helm-broker"}, actualPost.Spec.Containers[0].Args)
