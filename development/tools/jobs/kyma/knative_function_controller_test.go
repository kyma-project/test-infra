...
func TestKnativeFunctionControllerAcceptanceReleases(t *testing.T) {
	...
	for _, currentRelease := range tester.GetKymaReleaseBranchesBesides(unsupportedReleases) {
		t.Run(currentRelease, func(t *testing.T) {
			...
			actualPresubmit := tester.FindPresubmitJobByName(jobConfig.Presubmits["kyma-project/kyma"], tester.GetReleaseJobName("kyma-components-knative-function-controller", currentRelease), currentRelease)
