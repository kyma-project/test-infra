...
func TestApiControllerReleases(t *testing.T) {
	...
	for _, currentRelease := range tester.GetAllKymaReleases() {
		t.Run(currentRelease.String(), func(t *testing.T) {
			...
			actualPresubmit := tester.FindPresubmitJobByName(jobConfig.Presubmits["kyma-project/kyma"], tester.GetReleaseJobName("kyma-components-api-controller", currentRelease), currentRelease.Branch())
			...
			tester.AssertThatExecGolangBuildpack(t, actualPresubmit.JobBase, tester.ImageGolangBuildpack1_12, "/home/prow/go/src/github.com/kyma-project/kyma/components/api-controller")
		})
	}
}
...
func TestApiControllerJobsPresubmit(t *testing.T) {
	...
	actualPresubmit := tester.FindPresubmitJobByName(jobConfig.Presubmits["kyma-project/kyma"], "pre-master-kyma-components-api-controller", "master")
...
func TestApiControllerJobPostsubmit(t *testing.T) {
	...
	actualPostsubmit := tester.FindPostsubmitJobByName(jobConfig.Postsubmits["kyma-project/kyma"], "post-master-kyma-components-api-controller", "master")
	...
	assert.Equal(t, tester.ImageGolangBuildpack1_12, actualPostsubmit.Spec.Containers[0].Image)
