...
func TestIstioKymaPatchReleases(t *testing.T) {
	...
	for _, currentRelease := range tester.GetAllKymaReleases() {
		t.Run(currentRelease.String(), func(t *testing.T) {
			...
			actualPresubmit := tester.FindPresubmitJobByName(jobConfig.Presubmits["kyma-project/kyma"], tester.GetReleaseJobName("kyma-components-istio-kyma-patch", currentRelease), currentRelease.Branch())
...
func TestIstioKymaPatchJobsPresubmit(t *testing.T) {
	...
	actualPresubmit := tester.FindPresubmitJobByName(jobConfig.Presubmits["kyma-project/kyma"], "pre-master-kyma-components-istio-kyma-patch", "master")
...
func TestIstioKymaPatchJobPostsubmit(t *testing.T) {
	...
	actualPostsubmit := tester.FindPostsubmitJobByName(jobConfig.Postsubmits["kyma-project/kyma"], "post-master-kyma-components-istio-kyma-patch", "master")
