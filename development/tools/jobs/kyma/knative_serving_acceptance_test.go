...
func TestKnativeServingAcceptanceJobsPresubmit(t *testing.T) {
	...
	expName := "kyma-tests-knative-serving-acceptance"
	...
	tester.AssertThatJobRunIfChanged(t, actualPresubmit, "tests/knative-serving-acceptance/file")
...
func TestKnativeServingAcceptanceJobPostsubmit(t *testing.T) {
	...
	assert.Equal(t, "^tests/knative-serving-acceptance/", actualPost.RunIfChanged)
	assert.Equal(t, []string{"/home/prow/go/src/github.com/kyma-project/test-infra/prow/scripts/build.sh"}, actualPost.Spec.Containers[0].Command)
	assert.Equal(t, []string{"/home/prow/go/src/github.com/kyma-project/kyma/tests/knative-serving-acceptance"}, actualPost.Spec.Containers[0].Args)
}
