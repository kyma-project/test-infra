...
func TestKnativeServingAcceptanceJobPostsubmit(t *testing.T) {
	...
	tester.AssertThatExecGolangBuildpack(t, actualPostsubmit.JobBase, tester.ImageGolangBuildpackLatest, "/home/prow/go/src/github.com/kyma-project/kyma/tests/knative-serving")
