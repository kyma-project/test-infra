...
func TestConfigurationsGeneratorReleases(t *testing.T) {
	...
	for _, currentRelease := range tester.GetAllKymaReleaseBranches() {
		t.Run(currentRelease, func(t *testing.T) {
			...
			actualPresubmit := tester.FindPresubmitJobByName(jobConfig.Presubmits["kyma-project/kyma"], "kyma-components-configurations-generator", currentRelease)
			...
			tester.AssertThatExecGolangBuidlpack(t, actualPresubmit.JobBase, tester.ImageGolangBuildpackLatest, "/home/prow/go/src/github.com/kyma-project/kyma/components/configurations-generator")
		})
	}
}
...
func TestConfigurationsGeneratorJobsPresubmit(t *testing.T) {
	...
	actualPresubmit := tester.FindPresubmitJobByName(jobConfig.Presubmits["kyma-project/kyma"], "kyma-components-configurations-generator", "master")
...
func TestConfigurationsGeneratorJobPostsubmit(t *testing.T) {
	...
	expName := "kyma-components-configurations-generator"
