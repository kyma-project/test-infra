...
func TestLoadTestJobsPresubmit(t *testing.T) {
	...
	actualPresubmit := tester.FindPresubmitJobByName(jobConfig.Presubmits["kyma-project/kyma"], "pre-master-kyma-tools-load-test", "master")
...
func TestLoadTestPostsubmit(t *testing.T) {
	...
	actualPost := tester.FindPostsubmitJobByName(jobConfig.Postsubmits["kyma-project/kyma"], "post-master-kyma-tools-load-test", "master")
...
func TestLoadTestReleases(t *testing.T) {
	...
	for _, currentRelease := range releases.GetAllKymaReleases() {
		t.Run(currentRelease.String(), func(t *testing.T) {
			...
			// THEN
			require.NoError(t, err)
			actualPresubmit := tester.FindPresubmitJobByName(jobConfig.Presubmits["kyma-project/kyma"], tester.GetReleaseJobName("kyma-tools-load-test", currentRelease), currentRelease.Branch())
			require.NotNil(t, actualPresubmit)
