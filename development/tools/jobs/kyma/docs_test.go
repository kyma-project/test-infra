...
func TestDocsJobPresubmit(t *testing.T) {
	...
	tester.AssertThatHasExtraRefs(t, actualPresubmit.JobBase.UtilityConfig, []string{"test-infra"})
...
func TestDocsJobPostsubmit(t *testing.T) {
	...
	tester.AssertThatHasExtraRefs(t, actualPost.JobBase.UtilityConfig, []string{"test-infra"})
