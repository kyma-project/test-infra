...
func TestKymaIntegrationJobPeriodics(t *testing.T) {
	...
	tester.AssertThatContainerHasEnv(t, nightlyPeriodic.Spec.Containers[0], "MACHINE_TYPE", "custom-6-15360")
	...
	tester.AssertThatContainerHasEnv(t, weeklyPeriodic.Spec.Containers[0], "MACHINE_TYPE", "custom-8-15360")
	...
	assert.Equal(t, "eu.gcr.io/kyma-project/test-infra/kyma-cluster-infra:v20191120-66b27aac", nightlyAksPeriodic.Spec.Containers[0].Image)
