...
func TestKymaIntegrationJobPeriodics(t *testing.T) {
	...
	tester.AssertThatHasPresets(t, nightlyAksPeriodic.JobBase, tester.PresetGCProjectEnv, tester.PresetSaGKEKymaIntegration, "preset-stability-checker-slack-notifications", "preset-creds-aks-kyma-integration", "preset-kyma-development-artifacts-bucket")
	...
	assert.Len(t, nightlyAksPeriodic.Spec.Containers[0].Env, 7)
