...
func TestApiControllerAcceptanceTestsJobsPresubmit(t *testing.T) {
	...
	expName := "kyma-tests-api-controller-acceptance-tests"
...
func TestApiControllerAcceptanceTestsJobPostsubmit(t *testing.T) {
	...
	assert.Equal(t, "^tests/api-controller-acceptance-tests/", actualPost.RunIfChanged)
	assert.Equal(t, []string{"/home/prow/go/src/github.com/kyma-project/test-infra/prow/scripts/build.sh"}, actualPost.Spec.Containers[0].Command)
	assert.Equal(t, []string{"/home/prow/go/src/github.com/kyma-project/kyma/tests/api-controller-acceptance-tests"}, actualPost.Spec.Containers[0].Args)
}
