...
func TestAssetControllerJobPresubmit(t *testing.T) {
	...
	tester.AssertThatExecGolangBuildpack(t, actualPresubmit.JobBase, tester.ImageGolangKubebuilderBuildpackLatest, "/home/prow/go/src/github.com/kyma-project/kyma/components/assetstore-controller-manager")
}
...
func TestAssetControllerPostsubmit(t *testing.T) {
	...
	tester.AssertThatExecGolangBuildpack(t, actualPost.JobBase, tester.ImageGolangKubebuilderBuildpackLatest, "/home/prow/go/src/github.com/kyma-project/kyma/components/assetstore-controller-manager")
}
