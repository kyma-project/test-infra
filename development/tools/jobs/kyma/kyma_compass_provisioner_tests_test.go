...
func TestKymaGKECompassProvisionerTestsPresubmit(t *testing.T) {
	...
	// when
	actualJob := tester.FindPresubmitJobByNameAndBranch(jobConfig.AllStaticPresubmits([]string{"kyma-project/kyma"}), "pre-master-kyma-gke-compass-provisioner-tests", "master")
...
func TestKymaGKECompassProvisionerTestsPostsubmit(t *testing.T) {
	...
	// when
	actualJob := tester.FindPostsubmitJobByNameAndBranch(jobConfig.AllStaticPostsubmits([]string{"kyma-project/kyma"}), "post-master-kyma-gke-compass-provisioner-tests", "master")
	require.NotNil(t, actualJob)
