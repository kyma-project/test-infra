...
func TestApplicationOperatorTestsReleases(t *testing.T) {
	// WHEN
	for _, currentRelease := range tester.GetAllKymaReleases() {
		t.Run(currentRelease.String(), func(t *testing.T) {
			...
			actualPresubmit := tester.FindPresubmitJobByName(jobConfig.Presubmits["kyma-project/kyma"], tester.GetReleaseJobName("kyma-tests-application-operator-tests", currentRelease), currentRelease.Branch())
			...
			tester.AssertThatExecGolangBuildpack(t, actualPresubmit.JobBase, tester.ImageGolangBuildpackLatest, "/home/prow/go/src/github.com/kyma-project/kyma/tests/application-operator-tests")
		})
	}
}
...
func TestApplicationOperatorTestsJobsPresubmit(t *testing.T) {
	...
	// THEN
	require.NoError(t, err)
	actualPresubmit := tester.FindPresubmitJobByName(jobConfig.Presubmits["kyma-project/kyma"], "pre-master-kyma-tests-application-operator-tests", "master")
	require.NotNil(t, actualPresubmit)
...
func TestApplicationOperatorTestsJobPostsubmit(t *testing.T) {
	...
	expName := "post-master-kyma-tests-application-operator-tests"
