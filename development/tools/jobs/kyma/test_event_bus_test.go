...
func TestTestEventBusReleases(t *testing.T) {
	for _, currentRelease := range tester.GetAllKymaReleaseBranches() {
		t.Run(currentRelease, func(t *testing.T) {
			...
			actualPresubmit := tester.FindPresubmitJobByName(jobConfig.Presubmits["kyma-project/kyma"], tester.GetReleaseJobName("kyma-tests-event-bus", currentRelease), currentRelease)
			...
			tester.AssertThatExecGolangBuildpack(t, actualPresubmit.JobBase, tester.ImageGolangBuildpackLatest, "/home/prow/go/src/github.com/kyma-project/kyma/tests/event-bus")
		})
	}
}
...
func TestTestEventBusJobsPresubmit(t *testing.T) {
	...
	assert.Equal(t, []string{"/home/prow/go/src/github.com/kyma-project/kyma/tests/event-bus"}, actualPresubmit.Spec.Containers[0].Args)
}
...
func TestTestEventBusJobPostsubmit(t *testing.T) {
	...
	expName := "post-master-kyma-tests-event-bus"
