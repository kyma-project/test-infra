...
func TestNamespaceControllerTestsJobsPresubmit(t *testing.T) {
	...
	expName := "kyma-tests-test-namespace-controller"
	...
	tester.AssertThatJobRunIfChanged(t, actualPresubmit, "tests/test-namespace-controller/fix")
	assert.Equal(t, "^tests/test-namespace-controller/", actualPresubmit.RunIfChanged)
	assert.Equal(t, tester.ImageGolangBuildpackLatest, actualPresubmit.Spec.Containers[0].Image)
	assert.Equal(t, []string{"/home/prow/go/src/github.com/kyma-project/test-infra/prow/scripts/build.sh"}, actualPresubmit.Spec.Containers[0].Command)
	assert.Equal(t, "/home/prow/go/src/github.com/kyma-project/kyma/tests/test-namespace-controller", actualPresubmit.Spec.Containers[0].Args[0])
}
...
func TestNamespaceControllerTestsJobPostsubmit(t *testing.T) {
	...
	assert.Equal(t, "^tests/test-namespace-controller/", actualPost.RunIfChanged)
	assert.Equal(t, tester.ImageGolangBuildpackLatest, actualPost.Spec.Containers[0].Image)
	assert.Equal(t, []string{"/home/prow/go/src/github.com/kyma-project/test-infra/prow/scripts/build.sh"}, actualPost.Spec.Containers[0].Command)
	assert.Equal(t, "/home/prow/go/src/github.com/kyma-project/kyma/tests/test-namespace-controller", actualPost.Spec.Containers[0].Args[0])
