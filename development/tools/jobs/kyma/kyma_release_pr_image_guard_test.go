...
func TestKymaReleasePrImageGuard(t *testing.T) {
	...
	actualPresubmit := tester.FindPresubmitJobByName(jobConfig.Presubmits["kyma-project/kyma"], "pre-release-pr-image-guard", "release-*")
	...
	tester.AssertThatHasPresets(t, actualPresubmit.JobBase, tester.PresetDindEnabled)
