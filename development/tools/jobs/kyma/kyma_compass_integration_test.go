...
func TestKymaGKECompassIntegrationPresubmit(t *testing.T) {
	...
	// when
	actualJob := tester.FindPresubmitJobByNameAndBranch(jobConfig.PresubmitsStatic["kyma-project/kyma"], "pre-master-kyma-gke-compass-integration", "master")
...
func TestKymaGKECompassIntegrationPostsubmit(t *testing.T) {
	...
	// when
	actualJob := tester.FindPostsubmitJobByNameAndBranch(jobConfig.PostsubmitsStatic["kyma-project/kyma"], "post-master-kyma-gke-compass-integration", "master")
	require.NotNil(t, actualJob)
