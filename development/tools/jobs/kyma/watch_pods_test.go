...
func TestWatchPodsJobsPresubmit(t *testing.T) {
	...
	assert.Equal(t, []string{"/home/prow/go/src/github.com/kyma-project/kyma/tools/watch-pods"}, actualPresubmit.Spec.Containers[0].Args)
}
...
func TestWatchPodsJobPostsubmit(t *testing.T) {
	...
	assert.Equal(t, []string{"/home/prow/go/src/github.com/kyma-project/kyma/tools/watch-pods"}, actualPost.Spec.Containers[0].Args)
}
