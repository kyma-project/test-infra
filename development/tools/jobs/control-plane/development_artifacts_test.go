...
func TestKCPPresubmitDevelopmentArtifacts(t *testing.T) {
	...
	job := tester.FindPresubmitJobByNameAndBranch(jobConfig.AllStaticPresubmits([]string{"kyma-project/control-plane"}), "pre-main-kcp-development-artifacts", "master")
...
func TestKCPPostsubmitDevelopmentArtifcts(t *testing.T) {
	...
	job := tester.FindPostsubmitJobByNameAndBranch(jobConfig.AllStaticPostsubmits([]string{"kyma-project/control-plane"}), "post-main-kcp-development-artifacts", "master")
	require.NotNil(t, job)
