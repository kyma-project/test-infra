...
func TestHttpDbServiceAcceptanceTestsJobsPresubmit(t *testing.T) {
	...
	assert.Equal(t, []string{"/home/prow/go/src/github.com/kyma-project/examples/tests/http-db-service", "ci-pr"}, actualPresubmit.Spec.Containers[0].Args)
}
...
func TestHttpDbServiceAcceptanceTestsJobPostsubmit(t *testing.T) {
	...
	assert.Equal(t, []string{"/home/prow/go/src/github.com/kyma-project/examples/tests/http-db-service", "ci-master"}, actualPost.Spec.Containers[0].Args)
}
