...
func TestCommonJobPostsubmit(t *testing.T) {
	...
	tester.AssertThatHasPresets(t, actualPostsubmit.JobBase, tester.PresetDindEnabled, tester.PresetDockerPushRepoKyma, tester.PresetGcrPush, tester.PresetBuildMaster)
