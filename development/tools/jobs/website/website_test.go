...
func TestWebsiteJobPresubmit(t *testing.T) {
	...
	tester.AssertThatHasPresets(t, actualPresubmit.JobBase, tester.PresetBuildPr, tester.PresetWebsiteBotGithubIdentity, tester.PresetWebsiteBotGithubSSH, tester.PresetWebsiteBotGithubToken)
