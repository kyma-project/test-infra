...
| kyma-upgrade-k3d-kyma-to-kyma2 | k3d | kyma cli | kyma deploy |  | periodic |  upgrade-fast-integration  |
...
| kyma-upgrade-gardener-kyma2-to-main | gardener_azure | kyma cli | kyma install, kyma deploy |  | periodic |  upgrade-fast-integration  |
