...
| pre-main-kyma-integration-k3s-central-app-connectivity | k3s | k3s | kyma deploy |  | pr-submit |  fast-integration  |
| pre-main-kyma-integration-k3s-central-app-connectivity-compass | k3s | k3s | kyma deploy |  | pr-submit |  fast-integration  |
...
| pre-main-kyma-gke-integration-cosigned | gke | gcloud cli | kyma install |  | pr-submit |  octopus  |
...
| post-main-kyma-integration-k3s-central-app-connectivity | k3s | k3s | kyma deploy |  | pr-merge |  fast-integration  |
| post-main-kyma-integration-k3s-central-app-connectivity-compass | k3s | k3s | kyma deploy |  | pr-merge |  fast-integration  |
