...
| **preset-kyma-backup-credentials** | It sets the environment variable for the credentials json file of the service account with the permissions to write a read to the GCP bucket used for backups.|
