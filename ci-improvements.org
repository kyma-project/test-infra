...
If someone will build a product based on Kyma, he will also want to use first our CI/CD. The target user (persona) of the new CI/CD should be not only the developer of Kyma but also the developer of a Kyma based app.
