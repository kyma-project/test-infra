...
resource "google_artifact_registry_repository_iam_member" "image_syncer_prod_repo_writer" {
  ...
  location   = module.prod_docker_repository.artifact_registry_collection["prod"].location
  repository = module.prod_docker_repository.artifact_registry_collection["prod"].name
