# COMMENTED OUT: Terraform does not have admin access to manage Cloud Identity group memberships yet.
# These resources need to be managed manually until proper permissions are granted.
# Re-enable once Terraform service account has Cloud Identity Groups Admin role.
...
# }
# 
# resource "google_cloud_identity_group_membership" "azure_pipeline_image_builder_sa_to_hierarchical_group" {
#   provider = google.kyma_project
#   group    = var.restricted_registry_hierarchical_groups.image_signer_group_name
# 
#   preferred_member_key {
#     id = google_service_account.kyma_project_image_builder.email
#   }
# 
#   roles {
#     name = "MEMBER"
