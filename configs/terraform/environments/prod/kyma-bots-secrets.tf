...
resource "kubernetes_cluster_role" "access_kyma_bot_github_tokens_trusted_workloads" {
  ...
  rule {
    api_groups     = [""]
    resources      = ["secrets"]
    resource_names = [var.kyma_autobump_bot_github_token_secret_name, var.kyma_bot_github_token_secret_name, var.kyma_bot_github_sap_token_secret_name, var.kyma_bot_triage_token_secret_name, var.kyma_guard_bot_github_token_secret_name]
