...
import (
	...
	"flag"
	"fmt"
	clusterscollector2 "github.com/kyma-project/test-infra/pkg/tools/clusterscollector"
...
func main() {
	...
	clusterAPI := &clusterscollector2.ClusterAPIWrapper{Context: ctx, Service: clustersService}

	var clusterFilter clusterscollector2.ClusterRemovalPredicate
	...
	clusterFilter = clusterscollector2.TimeBasedClusterRemovalPredicate(exClustersMap)
	...
	gc := clusterscollector2.NewClustersGarbageCollector(clusterAPI, clusterFilter)
